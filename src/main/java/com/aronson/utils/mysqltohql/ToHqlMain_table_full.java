 ...
 * @author Sherlock
 */
public class ToHqlMain_table_full {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            Set<String> tableNames = ToHql("E:\\SQL\\act_proc_db.sql", "E:\\SQL\\act_proc_db" + "_full.hql");
    ...
    private static Set<String> ToHql(String sourceFile, String targetFile) throws Exception {
        ...
        while ((line = reader.readLine()) != null) {
            ...
            if (lineTemp.toUpperCase().contains("DROP TABLE IF EXISTS")) {
                ...
                stringBuffer.append(lineTemp).deleteCharAt(stringBuffer.length() - 1).deleteCharAt(stringBuffer.length() - 1).append("_full;\r\n");
                ...
                stringBuffer.append(stringBuilder).deleteCharAt(stringBuffer.length() - 1).deleteCharAt(stringBuffer.length() - 1).append("_full(\r\n");
                create++;
