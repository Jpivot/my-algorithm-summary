...
public class ToHqlMain_table {
    ...
    public static void main(String[] args) {
        try {
            ...
            Set<String> tableNames = ToHql("E:\\SQL\\card_format_table.sql",
                    "E:\\SQL\\card_format_table.hql");
    ...
    private static String handleType(String type, String lineTemp) {
        ...
        if ("char".equals(string) || "varchar".equals(string) || "text".equals(string) || "mediumtext".equals(string) || "time".equals(string)) {
            return "string";
